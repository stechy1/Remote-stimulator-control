...
public class OutputERPTest {
    ...
    public void testGetDefaultPulsUpValue() throws Exception {
        assertEquals("Chyba: Výchozí hodnota parametru 'pulsUp' má špatnou hodnotu", Output.DEF_PULS_UP, Integer.parseInt(output.getPulsUp()));
    }

    @Test
    public void testPulsUpValueNegativeToPositive() throws Exception {
        output.setPulsUp(String.valueOf(Output.MIN_PULS_UP - 1));
        ...
        output.setPulsUp(String.valueOf(Output.DEF_PULS_UP));
    ...
    public void testGetDefaultPulsDownValue() throws Exception {
        assertEquals("Chyba: Výchozí hodnota parametru 'pulsDown' má špatnou hodnotu", Output.DEF_PULS_DOWN, Integer.parseInt(output.getPulsDown()));
    }
    // endregion
    ...
    public void testGetDefaultDistributionValue() throws Exception {
        assertEquals("Chyba: Výchozí hodnota parametru 'distributionValue' má špatnou hodnotu", Output.DEF_DISTRIBUTION_VALUE, Integer.parseInt(output.getDistributionValue()));
    }
    // endregion
    ...
    public void testGetDefaultDistributionDelayValue() throws Exception {
        assertEquals("Chyba: Výchozí hodnota parametru 'distributionDelay' má špatnou hodnotu", Output.DEF_DISTRIBUTION_DELAY, Integer.parseInt(output.getDistributionDelay()));
    }
    // endregion
    ...
    public void testGetDefaultBrightnessValue() throws Exception {
        assertEquals("Chyba: Výchozí hodnota parametru 'brightness' má špatnou hodnotu", AConfiguration.DEF_BRIGHTNESS, Integer.parseInt(output.getBrightness()));
    }
    // endregion
